...
For example:
- When the exponent is set to \\(2^{0}\\), the grid spans the window between `1.0` and `2.0`  
- When the exponent increases to \\(2^{16}\\), the exact same normalized interval is scaled up to span `65,536.0` to `131,072.0`
